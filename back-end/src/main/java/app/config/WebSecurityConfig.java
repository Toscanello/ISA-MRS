...
import app.service.impl.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/pharmacist/delete/employment/**").hasRole("PH_ADMIN")
                .antMatchers("/api/discount/**").hasRole("PH_ADMIN")
                .antMatchers("/api/medicine/remove/pricing/**").hasRole("PH_ADMIN")
